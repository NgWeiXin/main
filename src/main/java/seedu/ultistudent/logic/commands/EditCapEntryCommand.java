...
public class EditCapEntryCommand extends Command {
    ...
    /**
     * @param index of the cap entry in the filtered cap entry list to edit
    ...
    /**
     * Stores the details to edit the cap entry with. Each non-empty field value will replace the
     * corresponding field value of the cap entry.
     */
